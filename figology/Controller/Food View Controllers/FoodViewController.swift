...
class FoodViewController: UIViewController {
    /**
     A class that allows the Food View Controller to manage the user's food intake and fibre consumption, and display the data in a table grouped by meals. It also allows the user to edit and delete food entries with Firebase.
    ...
    func updateProgressUI() {
        /**
         Updates the progress label and progress bar based on the user's fibre intake and tells the user to set their fibre goal if not already done.
         */
...
extension FoodViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        /**
         Configures and returns a Table View Cell with the food name, brand, mass consumed, and fibre content.
