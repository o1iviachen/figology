...
8. To install CocoaPods to this specific project, quit the project, open the Terminal and navigate to the folder containing the cloned repository using ``cd`` and the entire pathway of the file.
