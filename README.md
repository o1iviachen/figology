...
|https://docx.syndigo.com/developers/docs/search-item-endpoint|We used this as a reference to integrate the application's search functionality using Nutritionix API.|
